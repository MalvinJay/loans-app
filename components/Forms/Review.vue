    ...
    <Modal v-if="confirmModal" @close="confirmModal=false">
      <div class="mb-32">
        ...
        <div class="mt-16">
          ...
          <p class="text-center text-sm">
            I understand that by signing this declaration, I permit NBSSI to release information provided in this application:
            <ul>
              <li>
                (1) to any project sponsor, participating financial institutions, credit bureaus and/or third parties
              </li>
              <li>
                (2) to prepare presentations, publications, and marketing and promotional materials.
              </li>
            </ul>
          </p>
          <p class="text-center text-sm">
            I understand that if any information contained in this application is found to be fraudulent, my application details will be forwarded to the appropriate national security agency for further investigation and prosecution.
          </p>
          <p class="text-center text-sm">
