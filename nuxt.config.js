export default {
   ...
   */
  head: {
    title: process.env.npm_package_name || "Covid-19 Emergency Relief Fund",
    meta: [
      { charset: "utf-8" },
    ...
    link: [
      { rel: "icon", type: "image/x-icon", href: "/favicon.ico" },
      {
        rel: "stylesheet",
        href:
          "https://fonts.gstatic.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&display=swap"
      },
      {
