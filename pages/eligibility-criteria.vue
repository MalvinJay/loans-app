    ...
    <section id="criteria" class="py-8 md:py-40 px-40">
      ...
      <div class="mt-8 md:mt-24">
        <div class="point flex gap-10">
          ...
          <div>
            <p class="text-2xl">
              MSMEs providing services in demand during the pandemic and that have capability to grow and positively impact communities affected by the pandemic
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="limitations" class="py-10 md:py-40 px-40">
      ...
      <div class="mt-8 mr-8 md:mt-32 limitations">
        <div class="flex gap-10 my-10">
          ...
          <div>
            <p class="text-xl">
              There should be no undue private benefit
            </p>
          </div>
        </div>
        <div class="flex gap-10 my-10">
        ...
        <div class="flex gap-10 my-10">
          ...
          <div class="w-full">
            ...
            <div class="flex mr-12 mt-8 flex-wrap">
              ...
              <div class="card shadow-lg py-4 px-6 flex flex-col justify-center text-red-600 font-medium">
                Ownership by state or parastatal actors; for <br>
                manufacturing, EPA-regulation compliance
              </div>
            </div>
          </div>
        </div>
